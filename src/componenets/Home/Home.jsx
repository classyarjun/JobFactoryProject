...
const items = [
  {
    id: 1,
    image: "assets/herocarousel/19.jpg",
  ...
  {
    id: 2,
    image: "assets/herocarousel/20.jpg",
  ...
  {
    id: 3,
    image: "assets/herocarousel/21.jpg",
    ...
    <>
                ...
                >
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "linear-gradient(to right, rgb(0, 0, 0), rgba(0, 0, 139, 0.4))",
                    ...
                    >
                      ...
                      <p>{item.paragraph}</p>
                      <button className="btn_text text-light ">
                        {item.buttonText}
                      </button>
                    </div>
                  </div>
      ...
      <div className="servicessection p-5">
        ...
        >
          <h2>Services</h2>
          <p>
            Our <span className="description-title text-primary">Services</span>
          </p>
        </div>
              ...
              >
                <div className="service-item d-flex position-relative h-100">
                  ...
                  <div>
                    ...
                    <p className="description">
                      We assist individuals in finding bug and errors in
                      software
                    </p>
                  </div>
                </div>
      ...
      <div className="teamsection p-5">
        ...
        >
          ...
          <p>
            Meet Our{" "}
            <span className="description-title text-primary">Team</span>
          </p>
        </div>
                ...
                <div className="team-member d-flex align-items-start">
                  ...
                  <div className="member-info">
                    ...
                    <p style={{ textAlign: "justify" }}>
                      ...
                      He delivers quality solutions and has a proven track
                      record of successful projects, making him a valuable team
                      member.
                    </p>
      ...
      <div className="partnerssection p-5">
        ...
        >
          <h2>Partners</h2>
          <p>
            Our <span className="description-title text-primary">Clients</span>
          </p>
        </div>
      ...
      <div className="Contactsection p-5">
        ...
        >
          <h2>Contact</h2>
          <p>
            Contact <span className="description-title text-primary">Now</span>
          </p>
        </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      Croma Showroom, Ambedkar Chowk, Bajajnagar, Waluj, Chh.
